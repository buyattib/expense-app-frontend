...
const Toaster = ({ ...props }: ToasterProps) => {
	...
	const toastOptions: SonnerProps['toastOptions'] = {
		classNames: {
			...
			error: 'group toast group-[.toaster]:bg-error group-[.toaster]:text-error-foreground group-[.toaster]:border-border group-[.toaster]:shadow-lg',
